...
def extract_fashion_terms(sentences):
    ...
    fashion_keywords = ["dress", "style", "couture", "outfit", "designer", "seamstress", "silk", "tailor", "dressed",
                        "shirt", "dress", "skirt", "sleeve", "collar","lace", 'brocade','jacquard','tulle','chemise','cotton','jersey','knit','wool','cashmere','necklace','earrings','shoes','heels','sneakers','sandals','tweed','suit','pants','shorts','jacket','sweater','jumper','socks','filigree','gaiter','herringbone','pleat','hem','sew','raglan','seersucker','pockets','fabric','yoke',"woven","embroider","shirred","seam","denim","linen","satin","leather","blouse","velvet","blouse","hat","trousers","jeans","gloves"]
...
#     results = process_all_files(input_directory, max_files=3)
#
